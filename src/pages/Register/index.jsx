...
import { registerApiFn } from '../../utils/auth.fake'
  ...
  return (
    <div className='flex justify-center items-center pt-30'>
      <form action="" className='flex flex-col gap-1 w-[400px] rounded-2xl p-6 shadow-2xl' onSubmit={handleSubmit}>
        ...
        <button className='bg-blue-800 p-1 rounded text-white' type='submit' disabled={loading}>{loading ? 'Loading...' : 'Register'}</button>
